...
import { TransactionData } from '../../components/CreateSocialAtom/types'
import { toast } from 'sonner'

export const Route = createFileRoute('/create-atom/review')({
  component: ReviewStep,
})

function ReviewStep() {
  const navigate = useNavigate()
  const { formData, setTransactionData, transactionData } = useCreateAtom()
