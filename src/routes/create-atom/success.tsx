...
function SuccessStep() {
  ...
  const explorerUrl = 'https://testnet.intuition.sh/atoms'
          ...
          <div className="mt-6 space-y-3">
            ...
            {createdAtoms.social && (
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <a
                  href={`${explorerUrl}/${createdAtoms.social}`}
                  target="_blank"
            ...
            {createdAtoms.image && (
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <a
                  href={`${explorerUrl}/${createdAtoms.image}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:text-blue-700 ml-2 flex-shrink-0"
                >
            ...
            {createdAtoms.identity && (
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                ...
                <a
                  href={`${explorerUrl}/${createdAtoms.identity}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:text-blue-700 ml-2 flex-shrink-0"
                >
